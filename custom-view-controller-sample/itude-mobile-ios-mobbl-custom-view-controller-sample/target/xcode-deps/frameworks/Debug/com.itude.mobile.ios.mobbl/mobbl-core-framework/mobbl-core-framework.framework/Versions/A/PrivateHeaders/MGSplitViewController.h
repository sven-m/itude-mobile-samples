...
@interface MGSplitViewController : UIViewController <UIPopoverControllerDelegate> {
	BOOL _notifyChildViewControllersOfViewLifecycleDelegateMethodCalls; // See issue MOBBL-150
...
@property (nonatomic, assign) BOOL notifyChildViewControllersOfViewLifecycleDelegateMethodCalls; // See issue MOBBL-150
...
// Returns the size that the splitViewController can use
